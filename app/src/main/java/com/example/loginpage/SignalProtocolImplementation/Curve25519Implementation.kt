package com.example.loginpage.SignalProtocolImplementation
...
class Curve25519Implementation {
...
//            val decryptedMessage = EncryptionDecryption.decryptionMethod(cipherText,decryptionkey)
                Log.d("KeyPair : ",keyPair.publicKey.toString())
                Log.d("KeyPair : ",keyPair.privateKey.toString())
            return keyPair
        }
